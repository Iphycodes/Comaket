  ...
  return (
    <div className="mt-auto relative flex gap-1 items-center bg-neutral-100">
      <textarea
        ...
        rows={2}
        className="w-full px-3 !py-2 !outline-none focus:!outline-none border-neutral-300 focus:!border-none dark:border-neutral-700 dark:focus:border-blue bg-transparent transition-colors resize-none"
        onChange={(e) => {
