...
// mediaSize, useMediaQuery removed — unused
...
interface CreatorDetailsProductsTabProps {
  listings: any[];
...
const CreatorDetailsProductsTab: React.FC<CreatorDetailsProductsTabProps> = ({
  listings,
  listingsTotal,
  isLoading,
  isFetching,
  ...
  const handleWhatsAppMessage = (item: MarketItem) => {
    const phoneNumber = item.postUserProfile?.phoneNumber || creatorWhatsApp || '';
    if (!phoneNumber) {
    ...
    return (
      <div className="text-center py-16 bg-neutral-50 dark:bg-neutral-800/30 rounded-2xl">
        ...
        <p className="text-xs text-neutral-400 mt-1">
          Check back soon — this creator may add new items.
        </p>
      </div>
    );
  }
...
export default CreatorDetailsProductsTab;
