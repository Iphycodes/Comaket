...
import { Currencies, mockComments, mockMarketItems } from '@grc/_shared/constant';
...
const Product = ({ productId, setSelectedProductId }: ProductProps) => {
  ...
  return (
    <motion.div
      ...
      className={`bg-white dark:bg-gray-800 rounded-lg transition-all duration-300 mt-10 ${
        isMobile ? 'px-2' : ''
      }`}
    >
      {/* Seller Info */}
      ...
      <button
        ...
        className="absolute top-4 right-4 text-gray-500 hover:text-gray-700 font-semibold"
      >
        Close
      </button>
